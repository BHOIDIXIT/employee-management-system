import { ArrowRight, ArrowRightIcon, Calendar1, CalendarIcon, DollarSignIcon, FileTextIcon } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-8">
          {
            cards.map((card, index) => (
              <div key={index} className="card card-hover p-5 sm:p-6 relative overflow-hidden group flex items-center justify-between">
                ...
                <card.icon className='size-10 p-2.5 rounded-lg bg-slate-100 text-slate-600
